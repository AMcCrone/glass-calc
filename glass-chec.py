...
menu = st.sidebar.radio(
    "Navigation",
    ("Glass Design Strength Calculator", "Interlayer Relaxation Modulus 3D Plot")
)

# -----------------------
# Glass Design Strength Calculator Section
# -----------------------
if menu == "Glass Design Strength Calculator":
...
# -----------------------
elif menu == "Interlayer Relaxation Modulus 3D Plot":
